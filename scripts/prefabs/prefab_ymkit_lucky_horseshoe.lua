-- 超幸运马蹄铁：10倍幸运值，背包右键可与不幸马蹄铁互相转换。

local data = require('util/ymkit_item_stats').lucky_horseshoe
...
local function GetLuckFn(inst, owner)
    ...
    return ((owner ~= nil and EntityHasSetBonus(owner, EQUIPMENTSETNAMES.YOTH_KNIGHT))
        and TUNING.HORSESHOE_SETBONUS_LUCK * 10
        or TUNING.HORSESHOE_LUCK * 10) * mult
end
