local data = require('util/ymkit_item_stats').scissors
...
local assets = {
    Asset('ANIM', 'anim/scissors.zip'),
    Asset('ANIM', 'anim/swap_scissors.zip'),
    Asset('ATLAS', 'images/inventoryimages/ymkit_scissors.xml'),
    Asset('IMAGE', 'images/inventoryimages/ymkit_scissors.tex'),
}

local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol('swap_object', 'swap_scissors', 'swap_scissors')
...
local function fn()
    ...
    inst.AnimState:SetBank('scissors')
    inst.AnimState:SetBuild('scissors')
    inst.AnimState:PlayAnimation('idle')
    inst:AddTag('sharp')
    inst:AddTag('pointy')
    inst:AddTag('scissors')
    inst:AddTag('weapon')
    inst:AddTag('nosteal')
    ...
    inst.components.inventoryitem.imagename = 'ymkit_scissors'
    inst.components.inventoryitem.atlasname = 'images/inventoryimages/ymkit_scissors.xml'
    ...
    inst.components.weapon:SetDamage(config.scissors_damage)
